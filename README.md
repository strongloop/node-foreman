...
![List Foreman Directory](https://raw.github.com/NodeFly/node-foreman/master/assets/foreman-ls.png)

Once your Procfile is defined, run your application with `nf start`:

![Start Foreman](https://raw.github.com/NodeFly/node-foreman/master/assets/foreman-start.png)
