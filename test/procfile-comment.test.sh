...
assert_exit node ../nf.js export --out sandbox --env sandbox/.env --type upstart-single --procfile sandbox/Procfile
...
assert_exit diff -r -u fixtures/procfile-comment sandbox
