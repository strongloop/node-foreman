...
var Console = new function(){
	...
	this.info = function info(key,proc,string){
	    ...
	    console.log(proc.color(this.pad(stamp,this.padding)),
					colors.cyan(string));
	}
	...
	this.Alert = function Alert(){
	    console.log( colors.green('[OKAY] '+ this.fmt.apply(null,arguments)) );
	}
	
	this.Done = function Info(){
		console.log( colors.cyan('[DONE] ' + this.fmt.apply(null,arguments)) );
	}
	
	this.Warn = function Warn(){
	    console.warn( colors.yellow('[WARN] ' + this.fmt.apply(null,arguments)) );
	}

	this.Error = function Error(){
	    console.error( colors.bright_red('[FAIL] ' + this.fmt.apply(null,arguments)) );
	}
