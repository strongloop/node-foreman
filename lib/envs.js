...
// Given: "camelCaseString"
// Get: "CAMEL_CASE_STRING"
// Convert camel case string to upper snake case.
...
/*
{
  ...
  "TOP_OTHER_1": "one",
  "TOP_OTHER_2": "two",
  "CAMEL_CASE_WRITTEN_CONTENT":"value",
  "LAST": 42
}
*/
...
function flattenJSON(json) {
  ...
  walk(json, function(path, item) {
    flattened[path.map(camelToUpperSnakeCase).join('_')] = item
  })
